...
def plot_it(mol:str):
    ...
    if mol in melting_points:
        ...
        os.system("viewxvg -f temp_diff.xvg temp_S0.xvg temp_filesize.xvg %s %s -alfs 18 -lfs 14 -tfs 18 -legend_out -ymin -0.05 -ymax 1.2 -xmin %g -xmax %g -mk  -label D S0 Zip 'Tm,exp' 'Tm,sim' -title '%s' -pdf ../DYNAMICS/%s_dynamics.pdf -noshow" % ( tmexp, tmsim, xmin, xmax, title, mol ))
